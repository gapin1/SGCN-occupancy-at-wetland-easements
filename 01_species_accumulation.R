...
# Read in data ----
all07 <- read.csv("data/07_09_all.csv")
all22 <- read.csv("data/22_23_all.csv")
shrub07 <- read.csv("data/07_09_shrub.csv")
shrub22 <- read.csv("data/22_23_shrub.csv")
grass07 <- read.csv("data/07_09_grassland.csv")
grass22 <- read.csv("data/22_23_grassland.csv")
forest07 <- read.csv("data/07_09_forest.csv")
forest22 <- read.csv("data/22_23_forest.csv")
wet07 <- read.csv("data/07_09_wetland.csv")
wet22 <- read.csv("data/22_23_wetland.csv")
openwood07 <- read.csv("data/07_09_openwood.csv")
openwood22 <- read.csv("data/22_23_openwood.csv")
